...
namespace BDMSlackAPI
{
	public class RequestBase
	{
		...
		public virtual IEnumerable<KeyValuePair<String, String>> ToPairs()
		{
			yield return new KeyValuePair<String, String>("token", this.Token);
		}

		public virtual StringContent StringContent() => new(
				JsonConvert.SerializeObject(this),
				Encoding.UTF8,
				"application/json; charset=utf-8"
			);

		public virtual FormUrlEncodedContent FormUrlEncodedContent() => new(this.ToPairs());

		public virtual MultipartFormDataContent MultipartFormDataContent()
		{
