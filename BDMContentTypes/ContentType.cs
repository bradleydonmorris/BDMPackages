...
namespace BDMContentTypes
{
    public class ContentType
    {
        public IDictionary<String, String> Types { get; private set; }

        public String GetType(String filePath)
        {
            this.Types.TryGetValue(Path.GetExtension(filePath).ToLower(), out String returnValue);
            return returnValue;
        }

        public ContentType()
        {
            this.Types = new Dictionary<String, String>(StringComparer.OrdinalIgnoreCase)
            {
                { ".323", "text/h323" },
                { ".3g2", "video/3gpp2" },
                { ".3gp2", "video/3gpp2" },
